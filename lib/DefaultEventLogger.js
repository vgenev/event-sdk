...
class DefaultEventLogger {
    ...
    createTraceMetadata(service, traceId, sampled, flags, timestamp) {
        let newMeta = new EventMessage_1.EventTraceMetadata(service, traceId ? traceId : EventMessage_1.newTraceId(), EventMessage_1.newSpanId(), undefined, sampled, flags, timestamp);
        return newMeta;
    }
    ...
    createSpanForMessageEnvelope(messageEnvelope, service, traceId, spanOptions = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            eventMessage.metadata = new EventMessage_1.MessageMetadata(messageEnvelope.metadata.event, traceMetadata); // FIXME Copy the messageEnvelope.metadata.event in a new Object
