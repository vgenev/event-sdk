...
const event = {
    ...
    metadata: {
        event: new EventMessage_1.EventMetadata(// FIXME use EventMetadata.create and EventMetadata.createLog(...) EventMetadata.createTrace(...)
        "3920382d-f78c-4023-adf9-0d7a4a2a3a2f", new EventMessage_1.LogEventTypeAction(EventMessage_1.LogEventAction.debug), "2019-05-29T23:18:32.935Z", "1a396c07-47ab-4d68-a7a0-7a1ea36f0012", {
