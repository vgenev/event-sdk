...
const main = () => __awaiter(this, void 0, void 0, function* () {
    ...
    yield parentSpan.info('this is event message');
    ...
    yield parentSpan.audit('message', AuditEventAction.start);
    ...
    yield IIChildSpan.audit({ content: event }, AuditEventAction.end);
