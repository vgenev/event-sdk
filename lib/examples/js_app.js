...
const main = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const messageWithContext = yield IIChildSpan.injectContextToMessage(event);
    // await sleep(2000)
    const requestHeadersWithContext = yield IIChildSpan.injectContextToHttpRequest(request);
    ...
    yield IIChildSpan.finish(('error message'), state);
    yield sleep(500);
