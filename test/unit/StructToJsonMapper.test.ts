    ...
    jsonToStructMapperTests.test('convertStructToJson', (convertStructToJsonTest: any) => {
        ...
        convertStructToJsonTest.test('should map a Struct with Lists and sub structs correctly to a JSON', async (test: any) => {
            ...
            try {
                ...
                test.equal(moment(struct.fields.date1.stringValue).format(), moment(docDate).format(), 'OK!')
                ...
                test.equal(moment(struct.fields.array1.listValue.values[2].stringValue).format(), moment(docDate).format(), 'OK!')
                ...
                test.equal(moment(struct.fields.child.structValue.fields.date2.stringValue).format(), moment(docDate).format(), 'OK!')
                ...
                test.equal(moment(struct.fields.child.structValue.fields.array2.listValue.values[2].stringValue).format(), moment(docDate).format(), 'OK!')
