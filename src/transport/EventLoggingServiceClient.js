...
var JsonToStructMapper_1 = require('./JsonToStructMapper')
var EventLoggerServiceLoader_1 = require('./EventLoggerServiceLoader')
var path = require('path')
var grpc = require('grpc')
var EventLoggingServiceClient = /** @class */ (function () {
  function EventLoggingServiceClient (host, port) {
    var _this = this
    /**
         * Log an event
         */
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          return [2 /* return */, new Promise(function (resolve, reject) {
            var wireEvent = Object.assign({}, event)
            if (!event.content) {
            ...
            _this.grpcClient.log(wireEvent, function (error, response) {
    ...
    var eventLoggerService = EventLoggerServiceLoader_1.loadEventLoggerService()
    var client = new eventLoggerService(host + ':' + port, grpc.credentials.createInsecure())
    this.grpcClient = client
  }
  return EventLoggingServiceClient
}())
