...
abstract class ObjectWithKeys {
  [key: string]: any
}

type TraceContextCarrier = ObjectWithKeys 
...
// console.log(JSON.stringify(messageMetadata))
// let n = new EventTraceMetadata({serice: 'service'})
// console.log(n)

// n.finish()
// console.log(n.finishTimestamp)
// let a = new LogEventTypeAction({ action: LogEventAction.debug })
// let b = new LogEventTypeAction(LogEventAction.debug)
// console.log(b.getType())
// console.log(LogEventTypeAction.getType())
// console.log(a)
// console.log(a.getType())
// console.log(a.getAction())